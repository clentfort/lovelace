...
export function isMemoryStale(memory: Pick<MemoryRecord, "scope" | "source" | "updatedAt">, now = Date.now()): boolean {
...
export function taskStatusText(task?: TaskRecord, pr?: PrRecord, backlinkStatus?: BacklinkStatus): string | undefined {
...
export function formatMemoryBlock(memories: MemoryRecord[], task?: TaskRecord, pr?: PrRecord, backlinkStatus?: BacklinkStatus, now = Date.now()): string | undefined {
